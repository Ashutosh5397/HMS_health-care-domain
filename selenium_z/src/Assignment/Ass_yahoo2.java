...
public class Ass_yahoo2 {
		public void main(String[] args) throws InterruptedException {
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//input[@id='login-username']")).sendKeys("shushantkmr1999");
			Thread.sleep(2000);
			driver.findElement(By.xpath("//input[@id='login-signin']")).click();
			Thread.sleep(4000);
			driver.findElement(By.xpath("//input[@id='login-passwd']")).sendKeys("Susu@@123##");
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//input[@id='message-to-field']")).sendKeys("narendrakmr2001@yahoo.com");
			Thread.sleep(2000);
			...
			Thread.sleep(2000);
			redriver.findElement(By.xpath("//input[@id='login-username']")).sendKeys("narendrakmr2001");
			Thread.sleep(2000);
			redriver.findElement(By.xpath("//input[@id='login-signin']")).click();
			Thread.sleep(4000);
			redriver.findElement(By.xpath("//input[@id='login-passwd']")).sendKeys("nunu@@123##");
			Thread.sleep(2000);
